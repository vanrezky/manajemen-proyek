...
<body>
    ...
    <?php
    $data_utama = $data['data'];
    foreach ($data_utama as $key1 => $value1) { ?>
        ...
        <table class="tbl_head font8">
            <thead>
                <tr>
                    ...
                    <td width="2mm">:</td>
                    <td><b><?= $value1['data']['nama']; ?></b></td>
                </tr>
                <tr>
                    <td>Nomor SPK</td>
                    <td>:</td>
                    <td><b><?= $value1['data']['no_spk']; ?></b></td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td><b><?= $value1['data']['alamat']; ?></b></td>
                </tr>
                <tr>
                    <td>Mulai Proyek</td>
                    <td>:</td>
                    <td><b><?= tanggal($value1['data']['mulai']); ?></b></td>
                </tr>
                <tr>
                    <td>Selesai Proyek</td>
                    <td>:</td>
                    <td><b><?= tanggal($value1['data']['selesai']); ?></b></td>
                </tr>
                <tr>
                    <td>Nilai Kontrak</td>
                    <td>:</td>
                    <td><b><?= rupiah($value1['data']['nilai_kontrak']); ?></b></td>
                </tr>
            </thead>
            <tbody>
        ...
        <table class="tbl_body" cellpadding="0" cellspacing="0">
            ...
            <tbody>
                ...
                $sub_total_jasa = 0;
                $detail = $value1['detail'];
                $parent = $value1['parent'];
                if (!empty($detail)) {
                    ...
                    echo "<td colspan='5' class='borderleft borderbottomblack'><b>Grand Total Proyek " . $value['nama'] . "</b></td>";
